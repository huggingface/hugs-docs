...
2. Subscribe to the product in AWS Marketplace by following the instructions on the page. At the time of writing (December 2024), the steps are to:
   ...
   ![HUGS Configuration on AWS Marketplace](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/hugs/aws/hugs-configuration-inf2.png)
...
```bash
curl -O https://raw.githubusercontent.com/huggingface/hugs-helm-chart/main/aws/eks-inf2-cluster.yaml
```
