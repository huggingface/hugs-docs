...
HUGS provides the following AWS Neuron-compatible models within the HUGS 0.2.0 release (find below the Hugging Face Hub identifiers and their image name within the HUGS Container URIs available the offering):

- Hub ID [meta-llama/Meta-Llama-3.1-8B-Instruct](https://huggingface.co/meta-llama/Meta-Llama-3.1-8B-Instruct) with image name `neuron-meta-llama-meta-llama-3.1-8b-instruct`
- Hub ID [meta-llama/Meta-Llama-3.1-70B-Instruct](https://huggingface.co/meta-llama/Meta-Llama-3.1-70B-Instruct) with image name `neuron-meta-llama-meta-llama-3.1-70b-instruct`
- Hub ID [NousResearch/Hermes-3-Llama-3.1-8B](https://huggingface.co/NousResearch/Hermes-3-Llama-3.1-8B) with image name `neuron-nousresearch-hermes-3-llama-3.1-8b`
- Hub ID [NousResearch/Hermes-3-Llama-3.1-70B](https://huggingface.co/NousResearch/Hermes-3-Llama-3.1-70B) with image name `neuron-nousresearch-hermes-3-llama-3.1-70b`
- Hub ID [NousResearch/Nous-Hermes-2-Mixtral-8x7B-DPO](https://huggingface.co/NousResearch/Nous-Hermes-2-Mixtral-8x7B-DPO) with image name `neuron-nousresearch-nous-hermes-2-mixtral-8x7b-dpo`
- Hub ID [mistralai/Mixtral-8x7B-Instruct-v0.1](https://huggingface.co/mistralai/Mixtral-8x7B-Instruct-v0.1) with image name `neuron-mistralai-mixtral-8x7b-instruct-v0.1`
- Hub ID [mistralai/Mistral-7B-Instruct-v0.3](https://huggingface.co/mistralai/Mistral-7B-Instruct-v0.3) with image name `neuron-mistralai-mistral-7b-instruct-v0.3`
- Hub ID [mistralai/Mixtral-8x22B-Instruct-v0.1](https://huggingface.co/mistralai/Mixtral-8x22B-Instruct-v0.1) with image name `neuron-mistralai-mixtral-8x22b-instruct-v0.1`
