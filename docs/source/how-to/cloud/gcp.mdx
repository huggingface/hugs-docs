...
1. Go to [HUGS Google Cloud Marketplace listing](https://console.cloud.google.com/marketplace/product/huggingface-public/hugs__draft?authuser=1&project=huggingface-public)
...
2. Subscribe to the product in Google Cloud by following the instructions on the page. At the time of writing (September 2024), the steps are to:
